  ...
  return (
    <>
      <div className="container">
        <h3 className="mt-5 text-center text-white">Authors List</h3>
                ...
                >
                  <div className="card-body">
                    <p className="text-center workdetail ">
                      ...
                      <span className="small fw-bold  "> {element.Author}</span>{" "}
                      <i className="bi bi-person-vcard"></i>
                    </p>
                    <hr />
                    <p className="small ">{element.Bio}</p>
